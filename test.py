...
from model.networks import WaveCNN_CR_new, WaveCNN_CR
...
model.load_state_dict(torch.load('./checkpoints/color/cloud_removal_epoch_latest.pth'))

# --- Use the evaluation model in testing --- #
model.eval()
print('--- Testing starts! ---')
print('Length of test set:', len(test_dataloader))
test_psnr, test_ssim, test_ciede2000 = validation(model, test_dataloader, device, save_tag=True, save_path='./results/color/')
